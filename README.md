...
# Taverna Workbench Common Activities

[Taverna](https://web.archive.org/web/*/https://taverna.incubatorTT.apache.org/)
plugins for the
[Taverna Workbench](https://github.com/apache/incubator-taverna-workbench/),
providing user interface bindings for the
[Taverna Common Activities](https://github.com/apache/incubator-taverna-common-activities).
